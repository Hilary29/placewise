      ...
      <div className="container">
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-6">
          <div className="col-span-12 xl:col-span-6">
            ...
            <div className="p-3 sm:p-4 lg:p-6 bg-white rounded-md mb-1">
                <h4 className="mb-5 text-2xl font-semibold">Itineraire</h4>
                <div className="grid grid-cols-9 gap-4 md:gap-3  ">
                  <div className="col-span-4 md:col-span-4 ">
                    <div className="border border-neutral-40 rounded-2xl bg-[var(--bg-1)]  p-2 pl-4">
                      <div className="flex items-center justify-between gap-3 mb-1">

                        {/*Lieu de depart  du voyage*/}
                        <span className="clr-neutral-400 inline-block text-sm">
                        <i className="las la-map-marker-alt text-xl mr-1"></i>
                          Yaounde, Hopital Cite Verte
                        </span>
                  ...
                  <i className="text-xl las la-long-arrow-alt-right py-4 px-4 "></i>
              ...
              <div className="p-3 sm:p-4 lg:p-6 bg-white rounded-md mb-10">
                <ul className="flex flex-wrap items-center justify-between gap-1 gap-md-0">

                <div className="bg-[#F5F6FF] rounded-md shrink">
                <p className="mt-0 mb-8 text-2xl "> BMW 3 Series </p>
                  <Image
                    width={200}
                    height={260}
